public class Test3 {
    ...
    public static void main(String[] args) {
        ...
        */
        arr.sort((x, y) -> (x.getLength() - y.getLength()));
        ...
        */
        arr.sort((x, y) -> (x.getWidth() - y.getWidth()));
        ...
        */
        //You can have a whole interface method in a lambda.
        subList.replaceAll(x -> {
            x.setWidth(x.getWidth() + 1);
            return x;
        });
        ...
        */
        subList.removeIf(x -> (x.getLength() - 1) % 4 == 0);
        ...
        */
        subList.retainIf(x -> x.getWidth() > 40 && x.getWidth() < 100);
        System.out.println("\nDisplay contents of the sublist after removing " +
