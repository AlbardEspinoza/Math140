public class Set1 { //TODO; Write name and a brief description of the assignment.

    private int[] set;
    private int size;//Remember uninitialized instance variables always have the default value of 0.


    public Set1(int capacity) {/*Remember the name of the class and the name of the constructor have to be identical.
